...
def test_train_causal_lm_lora(_seed, _test_model_name, expected_out_train, tmp_path):
    set_seed(_seed)
    output_dir = tmp_path / "test_train_dir"
    actual: TrainOutput = train(
            model_name_or_path=_test_model_name,
...
def test_train_prompt_tuning_lora(_seed, _test_model_name, expected_out_train, tmp_path):
    set_seed(_seed)
    output_dir = tmp_path / "test_train_dir"
    actual: TrainOutput = train(
            model_name_or_path=_test_model_name,
